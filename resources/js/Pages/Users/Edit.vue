...
const role_id = ref(props.user.role ? props.user.role.id : '');
...
const submitForm = (e) => {
    ...
    router.put(`/users/${props.user.id}`, userData);
};
</script>
                ...
                <form @submit="submitForm">
                    ...
                    <div class="bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-8 sm:px-8">
                        <div class="flex items-center">
                            <div class="h-20 w-20 rounded-full bg-white bg-opacity-20 backdrop-blur-sm flex items-center justify-center text-white font-bold text-2xl shadow-lg">
