...
const submitForm = (e) => {
    ...
    router.put(`/categories/${props.category.id}`, categoryData, {
        onFinish: () => {
                    ...
                    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 px-8 py-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="mt-2 text-sm text-blue-100">Update the details for this category</p>
                            </div>
                            <div class="px-4 py-2 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg">
                                <span class="text-xs font-medium text-white">ID: {{ category.id }}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 border-2 border-dashed border-gray-300">
                            ...
                            <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
                                <div class="flex items-start gap-4">
                                    <div class="h-14 w-14 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-amber-800">
                                Updating this category will affect {{ category.products_count || 0 }} product(s).
                                Make sure the changes are appropriate for all products in this category.
                            </p>
                        </div>
                    </div>
                </div>
